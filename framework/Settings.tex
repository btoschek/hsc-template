...
\newcommand*{\acr}[1]{\acrshort{#1}\addtocounter{countacronym}{1}}
\newcommand*{\Acr}[1]{\acrlong{#1}\addtocounter{countacronym}{1}}

\newcounter{countnomen}
\DeclareTotalCounter{countnomen}
\newcommand*{\nomen}[2]{\nomenclature{#1}{#2}\addtocounter{countnomen}{1}}
...
\let\oldGlspl\Glspl
\let\oldglspl\glspl
\renewcommand*{\Gls}[1]{\oldGls{#1}\addtocounter{countglossary}{1}}
\renewcommand*{\Glspl}[1]{\oldGlspl{#1}\addtocounter{countglossary}{1}}
\renewcommand*{\gls}[1]{\oldgls{#1}\addtocounter{countglossary}{1}}
\renewcommand*{\glspl}[1]{\oldglspl{#1}\addtocounter{countglossary}{1}}
